...
| GKG, Mentions, VGKG, or multi-dataset joins | An established R/Python GDELT client, or BigQuery |
...
- **No GKG, Mentions, or any table beyond Events.** Multi-dataset support is on the [roadmap](limitations-and-roadmap.md), not built yet.
